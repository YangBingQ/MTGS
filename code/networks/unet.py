...
class Decoder(nn.Module):
    def __init__(self, params):
        ...
        # self.head=nn.Conv2d(self.ft_chns[0],self.n_class,kernel_size=3,padding=1)
        self.head=nn.Sequential(nn.Conv2d(self.ft_chns[0],64,4,4),
                                nn.BatchNorm2d(64),
                                nn.ReLU(),
                                nn.Conv2d(64,64,4,4),
                                nn.BatchNorm2d(64),
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        ...
        global_feature=feature[4]
        output,local_feature = self.decoder(feature)
